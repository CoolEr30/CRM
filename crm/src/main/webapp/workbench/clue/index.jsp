...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#cqx").click(function () {
			...
			$("input[name=cxz]").prop("checked",this.checked);

		})
		//反向全选操作

		$("#clueBody").on("click",$("input[name=cxz]"),function () {

			$("#cqx").prop("checked",$("input[name=cxz]").length==$("input[name=cxz]:checked").length);
		})
				...
				<table class="table table-hover">
					<thead>
						<tr style="color: #B3B3B3;">
							<td><input type="checkbox" id="cqx"/></td>
							<td>名称</td>
							<td>公司</td>
							<td>公司座机</td>
							<td>手机</td>
